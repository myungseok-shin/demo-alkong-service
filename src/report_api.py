...
class ReportAPI:
    def __init__(self, polling_interval=0.2):  # polling 간격 최적화
        ...
        # self.endpoint = os.getenv("REPORT_ENDPOINT")
        # self.api_url = os.getenv("API_URL")
        self.api_key = st.secrets["API_KEY"]
        self.endpoint = st.secrets["REPORT_ENDPOINT"]
...
if __name__ == "__main__":
    chat_summary_api = ReportAPI()
    with open('report_test_data/리포트생성-일반.json', 'r') as f:
